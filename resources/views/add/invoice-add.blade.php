...
@section('content')
    ...
    #student.select2-hidden-accessible + .select2-container .select2-selection--single {
        height: 35px !important;
        line-height: 35px !important;
    }
    #agency.select2-hidden-accessible + .select2-container .select2-selection--single {
        height: 35px !important;
        line-height: 35px !important;
    }
    ...
    <div class="invoice-card">
        ...
        <form action="{{ route('invoice.store') }}" method="POST" autocomplete="off">
            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="select2 form-control @error('student_id') is-invalid @enderror" id="student" name="student_id" onchange="RetriveInfoStudent();">
                            ...
                            @foreach($student as $s)
                                <option value="{{ $s->id }}" {{ old('student_id') == $s->id ? 'selected' : '' }}>{{ $s->enrollment }} | {{ $s->name }}</option>
                            @endforeach
                        </select>
                        @error('student_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="course_batch" class="form-control" readonly>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Total Fee</label>
                        <input type="number" id="total_fee" class="form-control" readonly>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label text-danger"><b>Balance Due</b></label>
                        <input type="number" id="balance_due" class="form-control" readonly>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label text-success">*Current Payable Amount*</label>
                        <input type="number" id="payment" name="pay_amount_student" class="form-control @error('pay_amount_student') is-invalid @enderror" value="{{ old('pay_amount_student') }}">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="select2 form-control @error('agency_id') is-invalid @enderror" id="agency" name="agency_id">
                            <option value="">--select---</option>
                            @foreach($agency as $s)
                                <option value="{{ $s->id }}" {{ old('agency_id') == $s->id ? 'selected' : '' }}>{{ $s->name }} | {{ $s->type }}</option>
                            @endforeach
                        </select>
                        @error('agency_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="pay_amount_agency" class="form-control @error('pay_amount_agency') is-invalid @enderror" value="{{ old('pay_amount_agency') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="lead_ref" class="form-control @error('lead_ref') is-invalid @enderror" value="{{ old('lead_ref') }}">
                        @error('lead_ref')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('notes') is-invalid @enderror" name="notes" rows="3" placeholder="Any additional information...">{{ old('notes') }}</textarea>
                @error('notes')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
